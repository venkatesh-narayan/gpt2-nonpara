...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_4L')
def transformer_lm_wiki103_4L(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 4) # only thing that's diff from transformer_lm_wiki103
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
    args.dropout = getattr(args, 'dropout', 0.1)
    args.adaptive_input = getattr(args, 'adaptive_input', True)
    args.tie_adaptive_weights = getattr(args, 'tie_adaptive_weights', True)
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_8L')
def transformer_lm_wiki103_8L(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 8) # only thing that's diff from transformer_lm_wiki103
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
    args.dropout = getattr(args, 'dropout', 0.1)
    args.adaptive_input = getattr(args, 'adaptive_input', True)
    args.tie_adaptive_weights = getattr(args, 'tie_adaptive_weights', True)
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_12L')
def transformer_lm_wiki103_12L(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 12) # only thing that's diff from transformer_lm_wiki103
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
    args.dropout = getattr(args, 'dropout', 0.1)
    args.adaptive_input = getattr(args, 'adaptive_input', True)
    args.tie_adaptive_weights = getattr(args, 'tie_adaptive_weights', True)
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_16L')
def transformer_lm_wiki103_16L(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 16) # only thing that's diff from transformer_lm_wiki103
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
    args.dropout = getattr(args, 'dropout', 0.3)
    args.adaptive_input = getattr(args, 'adaptive_input', True)
    args.tie_adaptive_weights = getattr(args, 'tie_adaptive_weights', True)
